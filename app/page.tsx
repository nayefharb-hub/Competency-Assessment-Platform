...
export default async function Home({
  ...
  // Row and scores arrive together — a count and a state, not the four joins
  // loadForAssessee would fetch.
  const mine = await findAssessmentWithScores(user);
  const archived = mine ? null : await findArchivedAssessment(user.id);
